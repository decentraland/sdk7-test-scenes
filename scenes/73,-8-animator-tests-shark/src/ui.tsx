...
const description = "Control animations on a 3D model. Trigger the animations by clicking on the shark. 1 click plays swim, 2nd click plays bite, 3rd click plays both, 4th click stops all"
const Max_Chars = 45
